...
Sub InitTCVN()
    TCVNVowels = ReadTextFile(GetLocalDirectory & "TCVNVowels.txt")
End Sub

Function UniStringToTCVNString(st As String) As String
    ...
    For i = 1 To Len(st)
        ...
        ' Find position of character in the vowel list
             ...
             Else
               ...
               text2 = text2 & Mid(TCVNVowels, Pos, 1)
             End If
        End If
    Next
    UniStringToTCVNString = text2
End Function
