...
Dim e As Integer, tu As String
    ...
    Else
        ...
        For i = 1 To sen.ParagraphCount
            ...
            Next j
        Next i
        lblTip1.Caption = ChrW(83) & ChrW(7889) & ChrW(32) & ChrW(99) & ChrW(226) & ChrW(117) & ChrW(32) & ChrW(116) & ChrW(225) & ChrW(99) & ChrW(104) & ChrW(32) & ChrW(273) & ChrW(432) & ChrW(7907) & ChrW(99) & ChrW(58) & sen.ParagraphCount & ChrW(46) & ChrW(32) & ChrW(83) & ChrW(7889) & ChrW(32) & ChrW(116) & ChrW(7915) & ChrW(32) & ChrW(116) & ChrW(225) & ChrW(99) & ChrW(104) & ChrW(32) & ChrW(273) & ChrW(432) & ChrW(7907) & ChrW(99) & ChrW(58) & sotu & "."
    End If
End Sub
...
Private Sub AddCaption()
    Me.Caption = "Giai Doan Tach Tu - Phien Ban " & App.Major & "." & App.Minor & "." & App.Revision
