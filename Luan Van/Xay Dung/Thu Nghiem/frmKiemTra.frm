...
Begin VB.Form frmKiemTra 
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   720
      Width           =   9975
      Begin MSForms.CheckBox chkKTCP 
         Height          =   375
         Left            =   120
         TabIndex        =   7
         Top             =   5400
...
Private Sub cmdKiemTra_Click()
    ...
    sen.Init txtThu
    If chkKTCP.Value Then
        sen.GrammerCheck = True
    End If
    If sen.Check(RDic) <> 0 Then Call ErrorHandle(e)
End Sub
...
Private Sub AddCaption()
    ...
    chkKTCP.Caption = ChrW(75) & ChrW(105) & ChrW(7875) & ChrW(109) & ChrW(32) & ChrW(84) & ChrW(114) & ChrW(97) & ChrW(32) & ChrW(67) & ChrW(250) & ChrW(32) & ChrW(80) & ChrW(104) & ChrW(225) & ChrW(112)
End Sub
